...
- [ ] CIV-002 - Audit exact versions and NeoForge intersection
...
- [ ] CIV-003 - Map release artifacts to immutable source commits
  ...
  - Blocker: Modern Companions CurseForge `2.0` does not yet map to the linked GitHub `v1.2.0` release/source state.

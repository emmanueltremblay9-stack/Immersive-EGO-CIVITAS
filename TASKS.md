...
- [ ] CIV-058 - Recruit MCA villager into MineColonies colony
  ...
  - Evidence: `build\gametest-smoke.log` reported `All 4 required tests passed :)`, including the upstream resident API contract; `build\install-report.json` installed `immersive_ego_civitas-0.1.0-alpha.8.jar` with SHA-256 `7b5d6733aa8b99f060256fa6e19dea2f2c5ad854da5ece87f6da17424996a26b`; `build\client-smoke-report.json` reported `result=passed`.

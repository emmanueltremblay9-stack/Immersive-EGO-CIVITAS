...
| Immersive EGO | LAB prerequisite `immersive_ego-0.1.0-alpha.37.jar` | 388048 | `259e4af9e524087d5d24cad9ec389edabb6087af637790aa3a0f0ea3e42c01d0` | `modId=immersive_ego`, version `0.1.0-alpha.37`, license `MIT`, NeoForge `[21.1.228,)`; installed jar hash matches the sibling build artifact, but the sibling source checkout is dirty |
...
| Immersive EGO | Local sibling repository `C:\Users\Emmanuel Tremblay\AI Depot\Codex Documents\Immersive EGO` is at HEAD `789238c475ecabc19808b9ac7d99df7f457670b8` and declares `0.1.0-alpha.37`, but its working tree has uncommitted source/doc/version changes. The sibling `build\libs\immersive_ego-0.1.0-alpha.37.jar` SHA-256 `259e4af9e524087d5d24cad9ec389edabb6087af637790aa3a0f0ea3e42c01d0` matches the installed Prism LAB prerequisite, which proves local binary parity only. Immutable source-to-binary mapping remains blocked until the sibling source state is committed and pushed or alpha.27 is restored. |
...
- Server smoke with CIVITAS `0.1.0-alpha.23` loads Immersive EGO
  `0.1.0-alpha.37` from the Prism LAB mods directory.
- The installed CIVITAS `0.1.0-alpha.23` jar is
  `immersive_ego_civitas-0.1.0-alpha.23.jar`, size `87736`, SHA-256
  `4f809300c073f0bd66bbfa9cffa256adc870e945379463c756f461a95beb34ff`, and
...
1. Commit and push the current Immersive EGO `0.1.0-alpha.37` source state, or

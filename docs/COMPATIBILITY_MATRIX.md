...
|---|---|---|---|---|
| CIVITAS | 1.21.1 | NeoForge | 0.1.0-alpha.4 | Harness builds, installs, and passes server/client smoke with pinned runtime guard |
| Immersive EGO | 1.21.1 | NeoForge | 0.1.0-alpha.27 | LAB prerequisite loaded in server smoke; source-to-binary proof pending dirty sibling worktree |
